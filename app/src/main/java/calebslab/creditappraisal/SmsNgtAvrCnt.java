...
public class SmsNgtAvrCnt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED) {
            ...
            gongtong.setPieChart(chartNight, gongtong.getSmsCount(startTime, endTime, getContentResolver()), time);
            Log.d(JJKIM, "end setPieChart");
        }

        // 파이조각 클릭시 비율을 Toast로 띄워줌
        chartNight.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            @Override
